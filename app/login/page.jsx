...
import LoginBtn from '../_components/auth/login-btn';

const Login = () => {
    return (
        <div>
            <section className="mt-[-40px] bg-gray-100 min-h-screen flex box-border justify-center items-center">
                <div className="bg-[#dfa674] rounded-2xl flex max-w-full p-5 items-center">
                    ...
                    <div className="md:block hidden w-1/2">
                        <img className="rounded-2xl max-h-[1600px]" src="https://img.freepik.com/free-photo/white-red-hearts_1048-4212.jpg?semt=ais_hybrid" alt="login form image" />
                    </div>
                </div>
            </section>
        </div>
