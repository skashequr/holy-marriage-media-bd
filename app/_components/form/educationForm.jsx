...
const EducationForm = ({ onPageChange }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
            ...
            <div className="w-full px-3 sm:w-1/3">
              <div className="mb-5">
                <input
                  type="text"
                  name="first"
                  placeholder="পরীক্ষা-সন"
                  value={formData.othersExam.first}
                  onChange={(e) => handleNestedChange(e, "othersExam")}
                  className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                />
              </div>
            </div>
            <div className="w-full px-3 sm:w-1/3">
              <div className="mb-5">
                <input
                  ...
                  name="second"
                  placeholder="পরীক্ষা-সন"
                  value={formData.othersExam.second}
                  onChange={(e) => handleNestedChange(e, "othersExam")}
                  className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                />
              </div>
            ...
            <div className="w-full px-3 sm:w-1/3">
              <div className="mb-5">
                <input
                  ...
                  name="third"
                  placeholder="পরীক্ষা-সন"
                  value={formData.othersExam.third}
                  onChange={(e) => handleNestedChange(e, "othersExam")}
                  className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                />
              </div>
      ...
      <button
        type="submit"
        className="mt-5 w-full rounded-md bg-[#6A64F1] py-3 text-white font-semibold"
      >
        Submit
      </button>
    </form>
