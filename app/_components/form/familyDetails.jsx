    ...
    <div className="-mx-3 flex flex-wrap">
        <div className="w-full px-3 sm:w-1/2">
            <div className="mb-5">
                ...
                <input type="text" name="area" id="area" placeholder=" খালা / মামাদের তথ্য"
                    className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
            </div>
        </div>
        <div className="w-full px-3 sm:w-1/2">
            <div className="mb-5">
                ...
                <input type="text" name="city" id="city" placeholder="চাচা / ফুপুদের তথ্য"
                    className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
            </div>
        </div>
        <div className="w-full px-3 sm:w-1/2">
            <div className="mb-5">
                ...
                <input type="text" name="state" id="state" placeholder="অভিভাবক এর নম্বর"
                    className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
            </div>
        </div>
        <div className="w-full px-3 sm:w-1/2">
